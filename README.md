...
├── 01-Static-Truss-Solver/           # 2D truss equilibrium & bar force solver
├── 02-Structural-Optimization/       # Cross-section optimization using fmincon / SQP
├── 03-Crane-Dynamics-ODE/            # Nonlinear crane pendulum motion & stresses
└── 04-Vibration-Signal-Analysis/     # Sensor FFT filtering, beam bending, GUM & Monte Carlo
